...
EXEC="python3 train_distill_optimized_correctives.py"
...
EXEC="python3 -u train_distill_optimized_correctives.py --data_root /datasets/instanthmr_data --num_workers 8 --batch_size 128 $useropt"
...
#SBATCH --output=instanthmr_distill/stdout_dolcino.txt
#SBATCH --error=instanthmr_distill/stderr_dolcino.txt
